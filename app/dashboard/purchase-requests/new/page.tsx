                  ...
                  <tr key={index} className="hover:bg-gray-50">
                    <td className="px-4 py-3 border-b border-gray-200">
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-sm text-gray-900 placeholder-gray-400"
                      />
                    </td>
                    <td className="px-4 py-3 border-b border-gray-200">
                      <input
                        ...
                        required
                        min="1"
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-sm text-gray-900 placeholder-gray-400 font-medium text-center"
                      />
                    </td>
                    <td className="px-4 py-3 border-b border-gray-200">
                      <input
                        ...
                        required
                        placeholder="pcs, kg"
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-sm text-gray-900 placeholder-gray-400 text-center"
                      />
                    </td>
                    <td className="px-4 py-3 border-b border-gray-200">
                      <input
                        ...
                        min="0"
                        placeholder="0"
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-sm text-gray-900 placeholder-gray-400 font-medium text-right"
                      />
                    </td>
                    <td className="px-4 py-3 border-b border-gray-200">
